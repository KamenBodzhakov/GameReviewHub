...
namespace GameReviewHub.Data.Migrations
{
    ...
    [Migration("20260203231947_RenameScoreToRating")]
    partial class RenameScoreToRating
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameReviewHub.Models.EntityModels.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameReviewHub.Models.EntityModels.GameGenre", b =>
                {
            ...
            modelBuilder.Entity("GameReviewHub.Models.EntityModels.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameReviewHub.Models.EntityModels.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameReviewHub.Models.EntityModels.GameGenre", b =>
                {
                    b.HasOne("GameReviewHub.Models.EntityModels.Game", "Game")
                        .WithMany("GameGenres")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GameReviewHub.Models.EntityModels.Genre", "Genre")
                        .WithMany("GameGenres")
